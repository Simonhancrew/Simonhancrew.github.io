...
3. **节省肌肉量，维持代谢率：**
   - 这是力量训练最重要的优势[^3]
   - 减脂期间，如果只做有氧不做力量，大约20-25%的体重下降来自肌肉
...
- "只要运动就能吃，不用管热量"：运动消耗的热量其实比你想象的少，跑5公里大约消耗体重(kg)×5 kcal（60kg的人约300kcal，80kg约400kcal），一杯奶茶就回来了
...
NEAT（Non-Exercise Activity Thermogenesis）是除了刻意运动之外所有身体活动消耗的热量，包括走路、站立、做家务、坐立不安等。

**为什么NEAT如此重要：**
- NEAT占总日消耗的 15-30%，个体差异极大（每天可相差 2000 kcal）
- 久坐办公人群 NEAT 可能只有 200-300 kcal/天，活跃人群可达 1000+ kcal/天
- 减脂期身体会**自动降低NEAT**（走路变慢、站立减少、小动作减少），这是代谢适应的重要组成部分[^1]
...
**如何监测和维持NEAT：**
- 使用计步器/手表追踪每日步数，设定最低目标（如 8000-10000步/天）
- 减脂期如果步数自然下降，刻意恢复到基线水平
- 站立办公、走路通勤、楼梯代替电梯
- 减脂期步数下降是代谢适应的早期信号，比体重平台更早出现

**实践建议：**
- 减脂期维持 NEAT 比增加有氧训练更可持续、更不容易导致过度训练
- 从能量系统角度，NEAT 主要是有氧供能，持续消耗脂肪
